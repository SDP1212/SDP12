...
public class InterceptorAI extends AI {
    ...
    private int ballTime0 = 1;
    private int ballTimeDelta = 3;
...
//			firstRun++;
        ...
        if (firstRun > ballTime0 + ballTimeDelta) {
            //calculate the velocity of the ball
            ballV.set((pitch.ball.getPosition().getX() - ballPosition0.getX()) / (firstRun - ballTime0), (pitch.ball.getPosition().getY() - ballPosition0.getY()) / (firstRun - ballTime0));

            //calculate time to get to ball
            timeToBall = (int) ((self.getPosition().getX() - ballPosition0.getX()) / (ballV.getX() - (1.0 / 70) * Math.cos(self.getOrientation().getDirectionRadians())));
...
//        System.out.println("ball = " + pitch.ball.getPosition().getX() + ", " + pitch.ball.getPosition().getY());
