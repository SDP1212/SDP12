...
public class ThresholdsState {
    ...
    private double ball_hlower_low;
    private double ball_hlower_high;
    private double ball_hupper_low;
    private double ball_hupper_high;
    ...
    public double getBall_hlower_low() {
        return ball_hlower_low;
    }

    public void setBall_hlower_low(double ballHLowerLow) {
        ball_hlower_low = ballHLowerLow;
    }

    public double getBall_hlower_high() {
        return ball_hlower_high;
    }

    public void setBall_hlower_high(double ballHLowerHigh) {
        ball_hlower_high = ballHLowerHigh;
    }

    public double getBall_hupper_low() {
        return ball_hupper_low;
    }

    public void setBall_hupper_low(double ballHUpperLow) {
        ball_hupper_low = ballHUpperLow;
    }

    public double getBall_hupper_high() {
        return ball_hupper_high;
    }

    public void setBall_hupper_high(double ballHUpperHigh) {
        ball_hupper_high = ballHUpperHigh;
    }
