...
public class CannyEdge {
   ...
   /**
     ...
     */
    public static int[][] getGrayscale(BufferedImage input){
     ...
     */
    public static int[][] detect(BufferedImage input, short noiselevel, short sobelmethod, float threshold){
        Gradient grad=sobel(noiseReduction(getGrayscale(input),noiselevel),sobelmethod);
